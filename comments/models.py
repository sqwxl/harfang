...
class Comment(MPTTModel, BaseCommentAbstractModel):
    ...
    edited_by = models.ForeignKey("auth.User", on_delete=models.CASCADE, null=True, blank=True)
    deleted_on = models.DateTimeField(null=True, blank=True)
    deleted_by = models.ForeignKey("auth.User", on_delete=models.CASCADE, null=True, blank=True)
